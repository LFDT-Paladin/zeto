...
As per section 13.a of the [Linux Foundation Decentralized Trust Charter](https://www.lfdecentralizedtrust.org/about/charter) all code submitted to the LF Decentralized Trust needs to have a [Developer Certificate of Origin](http://developercertificate.org/) (DCO) sign-off.
