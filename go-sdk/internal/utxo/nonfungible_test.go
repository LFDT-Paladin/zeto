...
func TestNonFungibleUTXOs(t *testing.T) {
	...
	assert.NoError(t, err)
	assert.Equal(t, "14387265223978393188138799516680159264477343701050531343910120918831961837958", idx1.String())
}
...
func TestNonFungibleUTXOsWithNullifiers(t *testing.T) {
	...
	idx1, err := utxo1.GetHash()
	assert.NoError(t, err)
	assert.Equal(t, "187a5bbc943a0fab725eaacf81872c4e023bb0deec1858ab2a43867f6646c0d8", idx1.Text(16))
}
